...
namespace win {
    ...
    // Window contructor
    Window::Window(const char *name, int width, int height, std::function<void(void)> mainFunc) : m_width(width), m_height(height), m_mainLoop(mainFunc) {
    ...
    // Object descontructor, frees the glfw resources
    Window::~Window() {
